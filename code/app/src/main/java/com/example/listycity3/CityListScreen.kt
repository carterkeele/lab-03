...
fun CityListScreen(
    ...
    // Part 2: input state for adding a city
    var newCityName by remember { mutableStateOf("") }
    var newProvinceName by remember { mutableStateOf("") }
    // Part 3: controls whether the add fields are visible
    var showAddCityFields by remember { mutableStateOf(false) }
    // Participation exercise: selected city + edit fields
    var selectedCity by remember { mutableStateOf<City?>(null) }
    var editCityName by remember { mutableStateOf("") }
    var editProvinceName by remember { mutableStateOf("") }

    Column(modifier = modifier.fillMaxSize()) {
        // Part 3: floating "+" button on the right
        Row(
        ...
        // Part 2 + 3: add fields, only shown after pressing "+"
        ...
        // Participation exercise: edit fields, only shown when a city is selected
